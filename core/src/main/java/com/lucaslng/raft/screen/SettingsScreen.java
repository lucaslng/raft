...
class SettingsScreen implements Screen {
	...
	protected SettingsScreen(Assets assets, ScreenManager screenManager) {
		...
		Label title = new Label("Settings", skin.get("title", LabelStyle.class));
		table.add(title).row();

		table.add(new Slider(0, 1, .1f, false, skin)).row();
